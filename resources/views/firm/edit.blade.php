                    ...
                    <div class="mt-3">                
                        <form action="/firm/{{$firm['id']}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" value= {{$firm['category']}}  name="category"  placeholder="--Firm Category--" required>
                            </div>
                            ...
                            <!-- Register No -->
                             ...
                             <div class="mb-3">
                                ...
                                <input type="text" class="form-control" value= {{$firm['about_us']}} name="about_us" placeholder="--About us:--" required>
                            </div>
